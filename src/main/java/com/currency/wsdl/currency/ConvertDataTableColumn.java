...
public class ConvertDataTableColumn  implements java.io.Serializable {
    private com.currency.wsdl.currency.ConvertDataTableColumnDs ds;
    ...
    public ConvertDataTableColumn(
           com.currency.wsdl.currency.ConvertDataTableColumnDs ds,
           int tableIndex,
     ...
     * @return ds
     */
    public com.currency.wsdl.currency.ConvertDataTableColumnDs getDs() {
        return ds;
    }
     ...
     * @param ds
     */
    public void setDs(com.currency.wsdl.currency.ConvertDataTableColumnDs ds) {
        this.ds = ds;
    }
