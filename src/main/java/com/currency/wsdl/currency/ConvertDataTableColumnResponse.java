...
public class ConvertDataTableColumnResponse  implements java.io.Serializable {
    private com.currency.wsdl.currency.ConvertDataTableColumnResponseDs ds;

    public ConvertDataTableColumnResponse() {
    }

    public ConvertDataTableColumnResponse(
           com.currency.wsdl.currency.ConvertDataTableColumnResponseDs ds) {
           this.ds = ds;
    }
     ...
     * @return ds
     */
    public com.currency.wsdl.currency.ConvertDataTableColumnResponseDs getDs() {
        return ds;
    }
     ...
     * @param ds
     */
    public void setDs(com.currency.wsdl.currency.ConvertDataTableColumnResponseDs ds) {
        this.ds = ds;
    }
