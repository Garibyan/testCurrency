...
public class ConverterLocator extends org.apache.axis.client.Service implements com.currency.wsdl.currency.Converter {
    ...
    public com.currency.wsdl.currency.ConverterSoap_PortType getConverterSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.currency.wsdl.currency.ConverterSoap_BindingStub _stub = new com.currency.wsdl.currency.ConverterSoap_BindingStub(portAddress, this);
    ...
    public com.currency.wsdl.currency.ConverterSoap_PortType getConverterSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.currency.wsdl.currency.ConverterSoap12Stub _stub = new com.currency.wsdl.currency.ConverterSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.currency.wsdl.currency.ConverterSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.currency.wsdl.currency.ConverterSoap_BindingStub _stub = new com.currency.wsdl.currency.ConverterSoap_BindingStub(new java.net.URL(ConverterSoap_address), this);
                _stub.setPortName(getConverterSoapWSDDServiceName());
                return _stub;
            }
            if (com.currency.wsdl.currency.ConverterSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.currency.wsdl.currency.ConverterSoap12Stub _stub = new com.currency.wsdl.currency.ConverterSoap12Stub(new java.net.URL(ConverterSoap12_address), this);
                _stub.setPortName(getConverterSoap12WSDDServiceName());
                return _stub;
            }
        }
